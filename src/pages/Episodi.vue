<template>
  <div class="Epcontainer">
    <md-card class="cardona">
      ...
      <md-card-header>
        <div class="md-title">Episodes</div>
      </md-card-header>
      <md-card-content>A collection of all the episodes from Rick and Morty. Click on the episode to see the details.
        <br>
        <br>
        <br>
        <div class="container">
          <div class="md-layout md-alignment-top-center">
            ...
            >
              ...
              <md-card-header>
                <div class="md-title">Season {{n}}</div>
                <div class="md-subhead">{{epForSeasonName[n-1].episodi.length}} Episodes</div>
              </md-card-header>
              <md-card-content>
