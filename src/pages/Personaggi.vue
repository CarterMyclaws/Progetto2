<template>
  <div class="containerz">
    <md-card class="cardona">
      ...
      <md-card-content>
        A collection of all the characters from Rick and Morty. Click
        Explore
        <md-icon>find_in_page</md-icon> to see the details of the character, or the favorite icon
        <md-icon>favorite_border</md-icon> to add the character to your
        Favorites.
  ...
  methods: {
    prefCheck(name) {
      ...
      if (this.preferiti === undefined) {
        console.log("preferiti è indefinito");
        return true;
      } else if (this.preferiti.length > 0) {
