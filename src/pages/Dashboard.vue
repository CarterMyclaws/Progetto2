          ...
          <md-card :class="[mobileScreen === false? 'std-card': 'card-mobile']">
            <md-card-media-cover md-solid>
              ...
              <md-card-area>
                ...
                <md-card-actions>
                  <md-button to="/Personaggi" class="md-raised" @click="scrollTop()">see all</md-button>
                </md-card-actions>
              </md-card-area>
            </md-card-media-cover>
          </md-card>
        ...
        <div class="md-layout-item md-large-size-40 md-medium-size-40 md-xsmall-size-100">
          <md-card>
            <md-card-media-cover md-solid>
              ...
              <md-card-area>
                <md-card-header>
                  <span class="md-title">Episodes</span>
                </md-card-header>

                <md-card-actions>
                  <md-button to="/Episodi" class="md-raised" @click="scrollTop()">see all</md-button>
                </md-card-actions>
              </md-card-area>
            </md-card-media-cover>
          </md-card>
